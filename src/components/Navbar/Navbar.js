        ...
        <div className='container w-100'>
            <div className='navbar-content flex fw-7'>
                <div className='brand-and-toggler flex flex-between w-100'>
                    <Link to = "/" className='navbar-brand fs-26'>Societies</Link>
                ...
                <div className={`navbar-collapse ${navToggle ? 'show-navbar-collapse' : ""}`}>
                    <div className='navbar-collapse-content'>
                        <ul className='navbar-nav'>
                            ...
                            <li className='text-white'>
                                <Link to = "/Pages/contact.js/">Contacts</Link>
                            </li>
                        </ul>
                        <ul className='navbar-social flex'>
                            <li className='text-white'>
                                <Link to = "https://twitter.com/" className='flex flex-center'><FaTwitter /></Link>
                            </li>
                            <li className='text-white'>
                                <Link to = "https://www.skype.com/en/" className='flex flex-center'><FaSkype /></Link>
                            </li>
                            <li className='text-white'>
                                <Link to = "https://vimeo.com/" className='flex flex-center'><FaVimeoV /></Link>
                            </li>
                        </ul>
